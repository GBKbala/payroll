                            ...
                            <form id="create_employee" class="needs-validation" novalidate>
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="m-2">
                                        <div class="row g-2 mb-2">
                                            ...
                                            <div class="col-md">
                                                <div class="form-floating">
                                                    <input type="text" data-type="name" class="form-control" id="phone" placeholder="" value="{{ $phone->phone }}" readonly>
                                        ...
                                        <div class="row g-2 mb-2">
                                            ...
                                            <div class="col-md">
                                                <div class="form-floating">
                                                    <input type="text" data-type="text" id="email" class="form-control" value="{{ $email->email }}" readonly>
                                        ...
                                        <div class="row g-2 mb-2">
                                            <div class="col-md">
                                                <div class="form-floating">
                                                    <input type="text" data-type="name" id="bankName" class="form-control" value="{{ $freelancer->bankName }}" readonly>
                                                    <label for="floatingInputGrid">Bank Name</label>
                                                </div>
                                            </div>
                                            <div class="col-md">
                                                <div class="form-floating">
                                                    <input type="text" data-type="number" id="accountNumber" class="form-control" value="{{ $freelancer->accountNumber }}" readonly>
                                        ...
                                        <div class="row g-2 mb-2">
                                            <div class="col-md">
                                                <div class="form-floating">
                                                    <input type="text" data-type="name" id="ifscCode" class="form-control" value="{{ $freelancer->ifscCode }}" readonly>
                                                    <label for="floatingInputGrid">IFSC Code</label>
                                                </div>
                                            </div>
                                            <div class="col-md">
                                                <div class="form-floating">
                                                    <input type="text" data-type="text" id="branch" class="form-control" value="{{ $freelancer->branch }}" readonly>
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="m-2">
                                        ...
                                        <div class="col-md-6">
                                                <div class="form-floating">
                                                    <input type="text" onkeypress="return limitInput(event)" data-type="text" id="projectName" class="form-control validate" value="{{$freelancer->projectName}}">
                                            ...
                                            <div class="col-md">
                                                <div class="form-floating">
                                                    <input  type="text" onkeypress="return limitInput(event)" data-type="number" class="form-control validate" id="amountPaid" placeholder="" value="{{$freelancer->freelancerAmount}}">
                                        ...
                                        <div class="row g-2 mb-2">
                                            <div class="col-md-6">
                                                <div class="form-floating" id="datepicker4">
                                                    <input type="text" data-type="date" id="paidDate" class="form-control validate" data-provide="datepicker" data-date-autoclose="true" data-date-container="#datepicker4" value="{{$freelancer->forTheMonth}}">
    ...
    <script type="text/javascript">
        ...
        function validate() {
            ...
            if(errorcount < 1){
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ route("freelancer.update",$freelancer->id) }}',
                    data: jsonData,
                    success: function(data){

                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Update Freelancer</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Update Freelancer</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                    ...
                    <div class="card-body">
                        <form id="create_employee" class="needs-validation" novalidate>
                            <div class="row mb-2">
                                ...
                                <div class="m-2">
                                    <div class="row g-2 mb-2">
                                        <div class="col-md">
                                            <div class="form-floating">
                                                <input type="text" onkeypress="return limitInput(event)" data-type="name" class="form-control" id="name" placeholder="" value="{{$freelancer_edit->name}}">
                                        ...
                                        <div class="col-md">
                                            <div class="form-floating" id="datepicker4">
                                                <input type="text" onkeypress="return limitInput(event)" onchange="return limitInput(event)" data-type="date" id="dob" class="form-control" data-provide="datepicker" data-date-autoclose="true" data-date-container="#datepicker4" value="{{$freelancer_edit->dob}}">
                                    ...
                                    <div class="row g-2 mb-2">
                                        <div class="col-md">
                                            <div class="form-floating">
                                                <input type="email" onkeypress="return limitInput(event)" data-type="email" id="email" name="example-email" class="form-control" placeholder="" value="{{$freelancer_edit->email}}">
                                        ...
                                        <div class="col-md">
                                            <div class="form-floating">
                                                <input type="text" onkeypress="return limitInput(event)" data-type="phone" id="phone" class="form-control" value="{{$freelancer_edit->phone}}">
                                    ...
                                    <div class="row g-2 mb-2">
                                        <div class="col-md">
                                            <div class="form-floating">
                                                <select onchange="return limitInput(event)" class="form-select" id="bloodgroup" aria-label="Floating label select example">
                                                    ...
                                                    <option value="a+" {{$freelancer_edit->bloodgroup == 'a+' ? 'selected':''}}>A +ve</option>
                                                    <option value="a1+" {{$freelancer_edit->bloodgroup == 'a1+' ? 'selected':''}}>A1 +ve</option>
                                                    <option value="a-" {{$freelancer_edit->bloodgroup == 'a-' ? 'selected':''}}>A -ve</option>
                                                    <option value="a1-" {{$freelancer_edit->bloodgroup == 'a1-' ? 'selected':''}}>A1 -ve</option>
                                                    <option value="b+" {{$freelancer_edit->bloodgroup == 'b+' ? 'selected':''}}>B +ve</option>
                                                    <option value="b-" {{$freelancer_edit->bloodgroup == 'b-' ? 'selected':''}}>B -ve</option>
                                                    <option value="ab+"  {{$freelancer_edit->bloodgroup == 'ab+' ? 'selected':''}}>AB +ve</option>
                                                    <option value="a1b+" {{$freelancer_edit->bloodgroup == 'a1b+' ? 'selected':''}}>A1B +ve</option>
                                                    <option value="a2b+" {{$freelancer_edit->bloodgroup == 'a2b+' ? 'selected':''}}>A2B +ve</option>
                                                    <option value="ab-" {{$freelancer_edit->bloodgroup == 'ab-' ? 'selected':''}}>AB -ve</option>
                                                    <option value="a1b-" {{$freelancer_edit->bloodgroup == 'a1b-' ? 'selected':''}}>A1B -ve</option>
                                                    <option value="a2b-" {{$freelancer_edit->bloodgroup == 'a2b-' ? 'selected':''}}>A2B -ve</option>
                                                    <option value="o+" {{$freelancer_edit->bloodgroup == 'o+' ? 'selected':''}}>O +ve</option>
                                                    <option value="O-" {{$freelancer_edit->bloodgroup == 'o-' ? 'selected':''}}>O -ve</option>
                                                </select>
                                        ...
                                        <div class="col-md">
                                            <div class="form-floating">
                                                <input type="text" onkeypress="return limitInput(event)" data-type="address" id="address" class="form-control" value="{{$freelancer_edit->address}}">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="m-2">
                                    <div class="row g-2 mb-2">
                                        <div class="col-md">
                                            <div class="form-floating">
                                                <input type="text" onkeypress="return limitInput(event)" data-type="name" id="bankName" class="form-control" value="{{$freelancer_edit->bankName}}">
                                        ...
                                        <div class="col-md">
                                            <div class="form-floating">
                                                <input type="text" onkeypress="return limitInput(event)" data-type="name" id="branch" class="form-control" value="{{$freelancer_edit->branch}}">
                                    ...
                                    <div class="row g-2 mb-2">
                                        <div class="col-md">
                                            <div class="form-floating">
                                                <input type="text"  data-type="ifsc" id="ifscCode" class="form-control" value="{{$freelancer_edit->ifscCode}}">
                                        ...
                                        <div class="col-md">
                                            <div class="form-floating">
                                                <input type="text" onkeypress="return limitInput(event)" data-type="number" id="accountNumber" class="form-control" value="{{$freelancer_edit->accountNumber}}">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="m-2">
                                    <div class="row g-2 mb-2">
                                        <div class="col-md">
                                            <div class="form-floating">
                                                <input type="text" onkeypress="return limitInput(event)" data-type="number" id="eID" class="form-control" value="{{$freelancer_edit->eID}}">
                            ...
                            <div class="button-list">
                                <button type="button" onclick="insert()" class="btn btn-success">Update  Freelancer</button>
                            </div>
                        </form>
                    </div> <!-- end card-body -->
                </div> <!-- end card -->
    ...
    <script type="text/javascript">
        ...
        function insert(){
            ...
            if(name ==''){
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('freelancer.update',$freelancer_edit->id) }}",
                    data: jsonData,
                    success: function(data){
                        if(data){
                            $.NotificationApp.send(data.status, data.message,"top-right", "rgba(0,0,0,0.2)", data.status);

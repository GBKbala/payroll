...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>@yield('title')GR Infotech</title>
        ...
        <div class="wrapper">
            ...
            <div class="leftside-menu">
                ...
                <a href="{{ route('index') }}" class="logo text-center logo-light">
                    <span class="logo-lg">
                        <img src="{{ asset('assets/images/GR_Infotech_final.png') }}" style="background: white" alt="" height="56">
                    </span>
                    <span class="logo-sm">
                        <img src="{{ asset('assets/images/fav.png') }}" style="background: white" alt="" height="16">
                    </span>
                </a>
                <!-- LOGO -->
                <a href="{{ route('index') }}" class="logo text-center logo-dark">
                    <span class="logo-lg">
                        <img src="{{ asset('assets/images/GR_Infotech_final.png') }}" alt="" height="56">
                    </span>
                    <span class="logo-sm">
                        <img src="{{ asset('assets/images/fav.png') }}" alt="" height="16">
                    </span>
                </a>
                <div class="h-100" id="leftside-menu-container" data-simplebar>
                    <ul class="side-nav">
                        @if(Session::get('isAdmin') == 1)
                            ...
                            <li class="side-nav-item">
                                <a href="{{ route('employee.all') }}" class="side-nav-link">
                            ...
                            <li class="side-nav-item">
                                <a href="{{ route('salary.all') }}" class="side-nav-link">
                                    <i class="mdi mdi-cash"></i>
                                    <span> Salary </span>
                                </a>
                            </li>
                            <li class="side-nav-item">
                                <a href="{{ route('employee.access') }}" class="side-nav-link">
                                    <i class="mdi mdi-card-account-details-star-outline"></i>
                                    <span> Employee Access </span>
                                </a>
                            </li>
                            <!-- <li class="side-nav-title side-nav-item">Freelance</li>
                            <li class="side-nav-item">
                                <a href="{{ route('freelancer.all') }}" class="side-nav-link">
                                    <i class="mdi mdi-card-account-details-star-outline"></i>
                                    <span> Freelance </span>
                                </a>
                            </li>
                            <li class="side-nav-item">
                                <a href="{{ route('freelancer-payments') }}" class="side-nav-link">
                                    <i class="mdi mdi-card-account-details-star-outline"></i>
                                    <span> Freelance  Payments</span>
                                </a>
                            </li> -->
                        @endif
                        {{-- <li class="side-nav-item">
                            <a href="{{ route('employee.leave') }}" class="side-nav-link">
                                <i class="mdi mdi-card-account-details-star-outline"></i>
                                <span>{{ Session::get('isAdmin') == 1 ? 'Leave' : 'Apply for leave' }}</span>
                            </a>
                        </li> --}}
                    </ul>
                    <!--- Sidemenu -->
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarPages">
                                <ul class="side-nav-second-level">
                                    ...
                                    <li>
                                        <a href="{{ route('pages.profile_2') }}">Profile 2</a>
                                    </li>
                                    <li>
                                    ...
                                    <li class="side-nav-item">
                                        ...
                                        <div class="collapse" id="sidebarPagesAuth">
                                            <ul class="side-nav-third-level">
                                                ...
                                                <li>
                                                    <a href="{{ route('pages.register_2') }}">Register 2</a>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <a href="{{ route('pages.recoverpassword') }}">Recover Password</a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('pages.recoverpassword_2') }}">Recover Password 2</a>
                                                </li>
                                                <li>
                                    ...
                                    <li>
                                        <a href="{{ route('pages.starter') }}">Starter Page</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('pages.preloader') }}">With Preloader</a>
                                    </li>
                                    <li>
            ...
            <div class="content-page">
                        ...
                        <ul class="list-unstyled topbar-menu float-end mb-0">
                            ...
                            <li class="dropdown notification-list">
                                <a class="nav-link dropdown-toggle nav-user arrow-none me-0" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false"
                                    ...
                                    <span>
                                        <span class="account-user-name">{{ explode('@', Session::get('email'))[0] }}</span>
                                        <span class="account-position">{{ Session::get('isAdmin') == 1 ? 'Admin' : 'User' }}</span>
                                    </span>
                                </a>
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-6">
                                <script>document.write(new Date().getFullYear())</script> © <a href="https://grinfotech.com/" target="_blank">grinfotech.com</a>
                            </div>
                            <div class="col-md-6">

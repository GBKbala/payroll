                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="card widget-flat">
                                <div class="card-body">
                                    ...
                                    <h5 class="text-muted fw-normal mt-0" title="Number of Customers">Total Employee</h5>
                                    <h3 class="mt-3 mb-3">{{ $all_employee }}</h3>
                        ...
                        <div class="col-sm-6">
                            <div class="card widget-flat">
                                <div class="card-body">
                                    <div class="float-end">
                                        <i class="mdi mdi-code-json widget-icon"></i>
                                    </div>
                                    <h5 class="text-muted fw-normal mt-0" title="Number of Orders">Developer's</h5>
                                    <h3 class="mt-3 mb-3">{{ $all_developers }}</h3>
                                    <p class="mb-0 text-muted">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="card widget-flat">
                                <div class="card-body">
                                    <div class="float-end">
                                        <i class="mdi mdi-bug-check widget-icon"></i>
                                    </div>
                                    <h5 class="text-muted fw-normal mt-0" title="Average Revenue">Tester's</h5>
                                    <h3 class="mt-3 mb-3">{{ $all_testers }}</h3>
                                    <p class="mb-0 text-muted">
                        ...
                        <div class="col-sm-6">
                            <div class="card widget-flat">
                                <div class="card-body">
                                    ...
                                    <h5 class="text-muted fw-normal mt-0" title="Growth">HR's</h5>
                                    <h3 class="mt-3 mb-3">{{ $all_hrs }}</h3>
                                    <p class="mb-0 text-muted">
                                ...
                                <tbody id="employeeSalaryList">
                                    @if($salaries)
                                        @foreach ($salaries as $salary)
                                            <td>{{ $salary->forTheMonth }}</td>
                                            <td><a href="{{ route('employee.print_paySlip', $salary->id) }}"><i class="dripicons-print"></i></a></td>
                                        @endforeach
                                    @endif
                                </tbody>
                            </table>

                                    ...
                                    <div class="row g-2 mb-2">
                                        ...
                                        <div class="col-md">
                                            <div class="form-floating" id="datepicker4">
                                                <input type="text" onkeypress="return limitInput(event)" data-type="date" id="dob" class="form-control" data-provide="datepicker" data-date-autoclose="true" data-date-container="#datepicker4">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="m-2">
                                    ...
                                    <div class="row g-2 mb-2">
                                        <div class="col-md">
                                            <div class="form-floating">
                                                <input type="text" onkeypress="return limitInput(event)" data-type="ifsc" id="ifscCode" class="form-control">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="m-2">
                                    <div class="row g-2 mb-2">
                                        ...
                                        <div class="col-md">
                                            <div class="form-floating">
                                                <input type="email" onkeypress="return limitInput(event)" data-type="email" id="officeEmail" name="example-email" class="form-control" placeholder="">
                                    ...
                                    <div class="row g-2 mb-2">
                                        <div class="col-md">
                                            <div class="form-floating">
                                                <input type="text" onkeypress="return limitInput(event)" data-type="text" id="department" class="form-control">
                                        ...
                                        <div class="col-md">
                                            <div class="form-floating">
                                                <input type="text" onkeypress="return limitInput(event)" data-type="text" id="designation" class="form-control">
                                    ...
                                    <div class="row g-2 mb-2">
                                        <div class="col-md">
                                            <div class="form-floating" id="datepicker4">
                                                <input type="text" onkeypress="return limitInput(event)" data-type="date" id="dateOfJoining" class="form-control" data-provide="datepicker" data-date-autoclose="true" data-date-container="#datepicker4">
                                        ...
                                        <div class="col-md">
                                            <div class="form-floating">
                                                <input type="text" onkeypress="return limitInput(event)" data-type="number" id="ctc" class="form-control">
